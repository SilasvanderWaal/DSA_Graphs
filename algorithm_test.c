...
dijkstra_test dtests[] = {
    ...
    {6,
     {'a', 'b', 'c', 'd', 'e', 'f'},
     22, {{'a', 'b', 9}, {'a', 'c', 13}, {'a', 'd', 7}, {'b', 'a', 9},
 {'b', 'c', 2}, {'b', 'e', 3},  {'b', 'f', 5}, {'c', 'a', 13},
 {'c', 'b', 2}, {'c', 'd', 1},  {'c', 'e', 5}, {'d', 'a', 7},
 {'d', 'c', 1}, {'d', 'e', 9},  {'d', 'f', 3}, {'e', 'b', 3},
 {'e', 'c', 5}, {'e', 'd', 9},  {'e', 'f', 1}, {'f', 'b', 5},
 {'f', 'd', 3}, {'f', 'e', 1}},
     'a', {0, 9, 8, 7, 11, 10},
     {'-', 'a', 'd', 'a', 'f', 'd'}                                                                              },
    {6,
...
flwa_test flwatests[] = {
    ...
    {3,
     {'a', 'b', 'c'},
     2,                                   {{'a', 'b', 1}, {'b', 'c', 2}},
     {{0, 1, 3}, {INFINITY, 0, 2}, {INFINITY, INFINITY, 0}}                                                                           },
    {3,
     {'a', 'b', 'c'},
     3,                    {{'a', 'b', 1}, {'b', 'c', 2}, {'c', 'a', 3}},
     {{0, 1, 3}, {5, 0, 2}, {3, 4, 0}}                                                                                                },
    ...
    {4,
     ...
     5,                                              {{'a', 'c', 2},
                                              ...
                                              {'c', 'b', 1},
                                              {'d', 'b', 1}},
     {{0, 3, 2, 3}, {5, 0, 7, 8}, {6, 1, 0, 9}, {6, 1, 8, 0}}                                                                         },
    // Directed graph {2/6}
    {4,
     {'a', 'b', 'c', 'd'},
     6,                                              {{'a', 'b', 1},
                                              ...
                                              {'c', 'd', 2},
                                              {'d', 'b', 2}},
     {{0, 1, 1, 3}, {1, 0, 2, 4}, {5, 4, 0, 2}, {3, 2, 4, 0}}                                                                         },
    // Directed graph {3/6}
    {5,
     {'a', 'b', 'c', 'd', 'e'},
     8,                                              {{'a', 'b', 2},
    ...
    {4,
     ...
     12,                                              {{'a', 'b', 3},
                                              ...
                                              {'d', 'b', 2},
                                              {'d', 'c', 5}},
     {{0, 3, 4, 1}, {3, 0, 1, 2}, {4, 1, 0, 3}, {1, 2, 3, 0}}                                                                         },
    ...
    {4,
     ...
     10,                                              {{'a', 'b', 2},
                                              ...
                                              {'d', 'b', 1},
                                              {'d', 'c', 5}},
     {{0, 2, 1, 3}, {2, 0, 3, 1}, {1, 3, 0, 4}, {3, 1, 4, 0}}                                                                         },
    ...
    {7,
     {'a', 'b', 'c', 'd', 'e', 'f', 'g'},
     20, {{'a', 'b', 1}, {'a', 'c', 7}, {'a', 'd', 3}, {'b', 'a', 1},
 {'b', 'e', 1}, {'b', 'g', 3}, {'c', 'a', 7}, {'c', 'd', 3},
 {'c', 'f', 1}, {'d', 'a', 3}, {'d', 'c', 3}, {'d', 'f', 2},
 {'e', 'b', 1}, {'e', 'g', 1}, {'f', 'c', 1}, {'f', 'd', 2},
 {'f', 'g', 1}, {'g', 'b', 3}, {'g', 'e', 1}, {'g', 'f', 1}},
     {{0, 1, 5, 3, 2, 4, 3},
     {1, 0, 4, 4, 1, 3, 2},
     {5, 4, 0, 3, 3, 1, 2},
     {3, 4, 3, 0, 4, 2, 3},
    ...
    {6,
     ...
     {1, 2, 0, INFINITY, INFINITY, INFINITY},
     {INFINITY, INFINITY, INFINITY, 0, 2, 1},
     {INFINITY, INFINITY, INFINITY, 2, 0, 3},
     {INFINITY, INFINITY, INFINITY, 1, 3, 0}}                                                                                         },
};
//---------------------------------------------------------------------
        ...
        for (int k = 0; k < node_cardinality(G); k++) // checking results
            for (int m = 0; m < node_cardinality(G); m++)
                if (flwatests[i].table[k][m] != d[k][m]) {
                    is_ok = false;
                    printf("%.0lf != %.0lf\n", flwatests[i].table[k][m],
                           d[k][m]);
                }
        print_verdict(is_ok, i);
        if (!is_ok)
            points -= (0.5 / (float)NFLOY);
        teardown();
    }
    if (points < 0.25)
        points = 0;
