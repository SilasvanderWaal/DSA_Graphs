...
edge_test upd_edge_t[] = {
    ...
    {2,
     {'a', 'b'},
     4, {{'a', 'a', 1}, {'a', 'b', 1}, {'b', 'a', 1}, {'a', 'a', 2}},
     3, {{'a', 'a', 2}, {'a', 'b', 1}, {'b', 'a', 1}}                                                                                  },
    {2,
     {'a', 'b'},
     4, {{'a', 'a', 1}, {'a', 'b', 1}, {'b', 'a', 1}, {'a', 'b', 2}},
     3, {{'a', 'a', 1}, {'a', 'b', 2}, {'b', 'a', 1}}                                                                                  },
    {2,
     {'a', 'b'},
     4, {{'a', 'a', 1}, {'a', 'b', 1}, {'b', 'a', 1}, {'b', 'a', 2}},
     3, {{'a', 'a', 1}, {'a', 'b', 1}, {'b', 'a', 2}}                                                                                  },
    // 3 nodes
    {3,
     {'a', 'b', 'c'},
     4, {{'a', 'b', 1}, {'b', 'b', 1}, {'b', 'c', 1}, {'a', 'b', 2}},
     3, {{'a', 'b', 2}, {'b', 'b', 1}, {'b', 'c', 1}}                                                                                  },
    {3,
     {'a', 'b', 'c'},
     4, {{'a', 'b', 1}, {'b', 'b', 1}, {'b', 'c', 1}, {'b', 'b', 2}},
     3, {{'a', 'b', 1}, {'b', 'b', 2}, {'b', 'c', 1}}                                                                                  },
    {3,
     {'a', 'b', 'c'},
     4, {{'a', 'b', 1}, {'b', 'b', 1}, {'b', 'c', 1}, {'b', 'c', 2}},
     3, {{'a', 'b', 1}, {'b', 'b', 1}, {'b', 'c', 2}}                                                                                  },
};
...
list_to_matrix_test list_matrix_t[] = {
    ...
    {3,
     ...
     5,                                         {{'a', 'a', 9},
                                         ...
                                         {'c', 'a', 7},
                                         {'c', 'c', 13}},
     {{9, INFINITY, 1}, {INFINITY, 2, INFINITY}, {7, INFINITY, 13}}                                                                     },
    ...
    {4,
     ...
     {4, INFINITY, INFINITY, 2},
     {INFINITY, INFINITY, 11, INFINITY},
